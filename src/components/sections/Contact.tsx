            ...
            >
              ...
              <div className={styles.connectBlock}>
                ...
                <div className={styles.socialLinks}>
                  ...
                  <a href="https://github.com/kerberosmdq" target="_blank" rel="noopener noreferrer" className={styles.socialBtn} data-cursor-text="GITHUB">
                  ...
                  <a href="mailto:miga.gls246@gmail.com" className={styles.socialBtn} data-cursor-text="EMAIL">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                  </a>
                  <a href="https://wa.me/5492234556968" target="_blank" rel="noopener noreferrer" className={styles.socialBtn} data-cursor-text={t('whatsapp')}>
